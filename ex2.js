...
console.log("Nuevo estado del vuelo: ", flightReservation.flightStatus);

// 2. Como compensación del restraso, nos han cambiado el ticket a 'First Class'
flightReservation.ticketClass = "First Class";
console.log("Nueva clase del vuelo: ", flightReservation.ticketClass);
...
console.log("Nueva hora estimada de salida: ", flightReservation.departure.time);
...
console.log("Nuevo tipo de comida especial: ", flightReservation.specialMeals[2]);
